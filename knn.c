...
double* knnParalel(int w, int xtrainSize, int xtestSize, double xtrain[xtrainSize][w], double xtest[xtestSize][w], double* ytrain, int nThreads) {
    ...
    int i;
    #pragma omp paralel num_threads(nThreads)
    {
        #pragma omp for
